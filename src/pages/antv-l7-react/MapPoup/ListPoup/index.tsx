 ...
 * @lastTime: 2023-12-08 16:56:33
 * @文件相对于项目的路径: /logic-umi/src/pages/antv-l7-react/MapPoup/ListPoup/index.tsx
 */
            ...
            <Row gutter={[3, 3]} >
              {
                dataSource?.basicInfo && Object.entries(dataSource?.basicInfo).map(([key, value]) => {
                  return (
                    <>
                      <Col span={12}>
                        <span>{DataMap?.basicInfo[key]}</span>
                      </Col>
                      <Col span={12}>
                        <span>{value}</span>
                      </Col>
            ...
            <Row gutter={[3, 3]} >
              {
                dataSource?.resourceInfo && Object.entries(dataSource?.resourceInfo).map(([key, value]) => {
                  return (
                    <>
                      <Col span={12}>
                        <span>{DataMap?.resourceInfo[key]}</span>
                      </Col>
                      <Col span={12}>
                        <span>{value}</span>
                      </Col>
